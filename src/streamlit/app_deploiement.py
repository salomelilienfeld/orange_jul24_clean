...
def PrepDonnees():
    ...
    with col1:
        st.image("data/PreparationDonnees.png", width=250)
...
def AnalyseDonnees():
    ...
    with col1:
        st.image("data/AnalyseDesDonnees.png", width=250, caption="Étapes d'analyse des données")
...
def ModelPredictDonnees():
    ...
    with col1:
        st.image("data/Modelisation.png", width=300, caption="Étapes de Modélisation")
...
def display_dynamic_filter_multi():
    ...
    # AMAJ
    df_filtre = pd.read_csv("data/accidents_graphiques_multi.csv")
...
def display_dynamic_filter():
    ...
    st.write("Utilisez ce filtre pour affiner vos résultats.")
    #st.header("🔎 Filtrage dynamique des données")
    df_filtre = pd.read_csv("data/accidents_graphiques.csv")
